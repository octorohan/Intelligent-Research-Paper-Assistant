# Intelligent-Research-Paper-Assistant (IRPA)
...
IRPA uses [uv](https://github.com/astral-sh/uv) for dependency management.
...
IRPA includes an automated RAG evaluation pipeline (`evaluate.py`) built on [DeepEval](https://github.com/confident-ai/deepeval).
